...
public class Empresa {
    ...
    public ArrayList<Sucursal> sucursalesEmpresa;
    public Empresa(String pid, String pNombre, String pDireccion, ArrayList<Sucursal> pListaSucursales){
        this.id =pid;
        this.nombre = pNombre;
        this.direccion = pDireccion;
        this.sucursalesEmpresa = pListaSucursales;
    }

    public Empresa() {
    }

    public Empresa(String number, String grido, String s) {
    }
    ...
    public static void gestionEmpresas(Scanner keyboard){
        limpiarConsola();
        boolean salir = false;
        while(salir == false){
    ...
    public static void altaEmpresa(Scanner keyboard){
        ...
        ArrayList<Sucursal> pLista = new ArrayList<Sucursal>();

        Empresa pEmpresa = new Empresa(pId, pNombre, pdireccion, pLista);
    ...
    public static void insertar (Empresa pEmpresa){
        pListaEmpresas.add(pEmpresa);
    }
